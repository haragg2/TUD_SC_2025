...
z = iddata([theta1_data, theta2_data], u_data, h, 'Name', 'Rot_Pendulum');
z.InputName = 'Voltage';
z.InputUnit =  'V';
...
Parameters    = [50; 0.1667; 1; 0.981; 41.6667; 0.981];         % Initial parameters. Np = 6.
InitialStates = [0.72; 0; -0.71; 0];            % Initial initial states.
